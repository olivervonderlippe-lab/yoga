...
const POSES = {
  ...
  pincha:           { id:"pincha",            name:"Forearm Balance",         sanskrit:"Pincha Mayurasana",            emoji:"🤸", tree:"inversion",    defaultStatus:"open"    },
...
const POSE_DETAILS = {
  ...
  chaturanga:       { why:"Schulterstabilität unter Last. Trainiert die Drucklinie für Crow und Arm Balances.", nextStep:"Slow Negatives 4 Sek. als Standard halten.", connects:["plank","crow"], videos:[{label:"Chaturanga korrekt",q:"chaturanga tutorial alignment yoga"}] },
  crow:             { why:"Erste echte Arm Balance. Problem ist fast nie Kraft – sondern Schwerpunkt und Compression.", nextStep:"Crow Lean Drill täglich: Schultern über Handgelenke. Tuck Hold: Compression aufbauen. Crow Hop: Gewicht weiter vor bis Zehen sich heben.", connects:["tuck_hold","side_crow","flying_pigeon"], videos:[{label:"Crow Lean Drill",q:"crow pose lean drill tutorial bakasana"},{label:"Crow Hop Tutorial",q:"crow pose hop first time tutorial"},{label:"Crow 20 Sek. halten",q:"crow pose hold 20 seconds tutorial"}] },
  ...
  dolphin:          { why:"Unterarmstütze mit hoher Hüfte. Direkter Vorläufer für Headstand und Pincha. 45 Sek. = Headstand-Freigabe.", nextStep:"45 Sek. Hold als Headstand-Freigabe.", connects:["headstand","pincha"], videos:[{label:"Dolphin Hold",q:"dolphin pose headstand prep tutorial"},{label:"Dolphin Rocks",q:"dolphin rocks forearm balance"}] },
  headstand:        { why:"Erste echte Inversion. Gewicht liegt auf UNTERARMEN, nicht dem Kopf.", nextStep:"Dolphin 45 Sek. stabil. Dann: Kopf auf Matte, Hüfte hoch, Knie zur Brust.", connects:["dolphin","pincha"], videos:[{label:"Headstand Anfänger",q:"headstand tutorial beginners sirsasana"},{label:"Headstand Approach",q:"headstand approach step by step"}] },
  pincha:           { why:"Unterarme am Boden, Körper senkrecht. Braucht starke Schultern aus dem Headstand.", nextStep:"Headstand stabil. Dann Pincha gegen Wand – Schulterblätter zusammenziehen.", connects:["dolphin","headstand","handstand"], videos:[{label:"Pincha Tutorial",q:"pincha mayurasana forearm balance tutorial"}] },
  handstand:        { why:"Königsdisziplin. Braucht Schultern, Core, Balance, Handgelenke, Raumgefühl.", nextStep:"Wall Handstand 20 Sek. → Shoulder Taps → Kick-Ups → Freestanding.", connects:["pincha","press_hs_prep"], videos:[{label:"Wall Handstand",q:"wall handstand tutorial beginner"},{label:"Handstand Kick-Up",q:"handstand kick up controlled tutorial"}] },
  ...
  double_pigeon:    { why:"Tiefste Außenrotation im Sitzen. Schlüssel für Lotus UND Flying Pigeon.", nextStep:"3 Min./Seite, nicht forcieren. Block unter Gesäß wenn nötig.", connects:["pigeon","half_lotus","flying_pigeon"], videos:[{label:"Double Pigeon Tutorial",q:"double pigeon fire log pose tutorial"},{label:"Double Pigeon tiefer",q:"double pigeon deeper progression"}] },
  ...
  lotus:            { why:"Volle Außenrotation beider Hüften. Langfristiges Ziel.", nextStep:"Half Lotus entspannt. NIE Druck aus dem Knie.", connects:["half_lotus"], videos:[{label:"Lotus Prep sicher",q:"lotus pose safe preparation tutorial"}] },
  forward_fold:     { why:"Foundation für Hamstring-Arbeit.", nextStep:"Solide.", connects:["half_splits","hanumanasana","firefly"], videos:[{label:"Forward Fold korrekt",q:"standing forward fold yoga correct alignment"}] },
  ...
  l_sit:            { why:"Beide Beine parallel zum Boden. Größter einzelner Hebel im System. Wenn L-Sit kommt: Crow stabiler, Firefly möglich, Jump Backs öffnen sich.", nextStep:"Tuck Hold 8 Sek. → One Leg Extended → beide Beine extended. Auch 1 Sek. zählt.", connects:["tuck_hold","tolasana","firefly","crow"], videos:[{label:"L-Sit Tutorial komplett",q:"l-sit tutorial progression beginner complete"},{label:"One Leg Extended",q:"one leg extended l-sit progression"}] },
  ...
  standing_figure4: { why:"Brücke zwischen Hip Opening und Flying Pigeon. Trainiert Hüftaußenrotation unter Last und Schwerpunktverlagerung nach vorne.", nextStep:"Figure-4 im Stand stabil halten, dann Hände auf Blöcke/Boden und Gewicht nach vorne.", connects:["pigeon","double_pigeon","flying_pigeon"], videos:[{label:"Standing Figure-4 Lean",q:"standing figure 4 lean flying pigeon prep"}] },
  flying_pigeon:    { why:"Eka Pada Galavasana – Crow mit offener Hüfte. Integration aus Crow, Hip Rotation und Balance.", nextStep:"Crow 15 Sek. + Double Pigeon 3 Min. entspannt + Standing Figure-4 Lean kontrolliert.", connects:["crow","double_pigeon","standing_figure4"], videos:[{label:"Flying Pigeon Tutorial",q:"flying pigeon eka pada galavasana tutorial"},{label:"Flying Pigeon Approach",q:"flying pigeon approach step by step"}] },
};
...
const MASTER_DETAILS = {
  down_dog:      { focus:"Schulteröffnung, lange Wirbelsäule, aktive Rückseite",       biggestLimit:"Keine große Baustelle – Foundation ist solide",           readiness:["90 Sek. ohne Schulterermüdung","Schultern aktiv, nicht passiv","Fersen Richtung Boden"],                         bestDrills:["Shoulder Flexion Stretch","Scapula Push-ups","Dolphin Hold"],     targetHold:90, unit:"sek" },
  dolphin:       { focus:"Schulterkraft, Core, Inversion Prep",                         biggestLimit:"45 Sek. Hold als Headstand-Freigabe",                     readiness:["45–60 Sek. stabil","Unterarme parallel","Druck im Core, nicht im Nacken"],                                   bestDrills:["Dolphin Hold","Dolphin Rocks","Forearm Plank"],                   targetHold:60, unit:"sek" },
  chaturanga:    { focus:"Schulterstabilität, exzentrische Kontrolle, Drucklinie",      biggestLimit:"Keine große Baustelle – Slow Negatives als Qualitätscheck", readiness:["5 Slow Negatives à 4 Sek.","Ellbogen eng am Körper","Schultern nicht unter Ellbogenlinie"],                 bestDrills:["Slow Chaturanga Negatives","Plank Hold","Scapula Push-ups"],      targetHold:5,  unit:"wdh" },
  crow:          { focus:"Schwerpunktkontrolle, Compression, erste echte Arm Balance",  biggestLimit:"Schwerpunkt + Compression – nicht Kraft",                  readiness:["Tuck Hold 8 Sek.","Chaturanga 5× sauber","Schultern aktiv über Hände bringen"],                           bestDrills:["Crow Lean Drill","Crow Hop","Tuck Hold"],                         targetHold:20, unit:"sek" },
  l_sit:         { focus:"Compression, tiefe Hüftbeuger, untere Bauchlinie",            biggestLimit:"Größter Hebel im gesamten System",                         readiness:["Tuck Hold 8–10 Sek.","Hollow Body Hold 20–30 Sek.","Seated Pulses kontrolliert"],                          bestDrills:["Tuck Hold","Seated Compression Pulses","One Leg Extended"],      targetHold:10, unit:"sek" },
  pigeon:        { focus:"Hüftaußenrotation, Gesäßmobilität, kniesichere Öffnung",      biggestLimit:"Ab ca. 45° beginnt Kniekompensation",                      readiness:["Low Lunge tief","Lizard solide","2 Min. ohne Knieschmerz"],                                              bestDrills:["90/90 Rotations","Elevated Pigeon","Passive Pigeon"],             targetHold:2,  unit:"min" },
  half_lotus:    { focus:"Tiefe Hüftaußenrotation, Lotus-Zwischenstufe",                biggestLimit:"Knie bleibt hoch – Außenrotation reicht noch nicht",       readiness:["Double Pigeon 2–3 Min. entspannt","Figure-4 ohne Knieschmerz","Fuß dorsalflektiert halten"],           bestDrills:["Double Pigeon","Figure-4 Stretch","90/90 Active Rotation"],      targetHold:60, unit:"sek" },
  flying_pigeon: { focus:"Crow + Hip Rotation + Schwerpunkt auf die Hände",             biggestLimit:"Gewicht kommt noch nicht voll auf die Hände",              readiness:["Crow 10–15 Sek. stabil","Double Pigeon 3 Min. entspannt","Standing Figure-4 Lean kontrolliert"],         bestDrills:["Standing Figure-4 Lean","Figure-4 auf Blöcken","Crow Lean Drill"], targetHold:5, unit:"sek" },
};

const DIAGNOSTIC_TESTS = [
  { id:"hip_compression",        name:"Hip Compression",         short:"Knie aktiv zur Brust",            unit:"cm",      emoji:"🦵", description:"Sitz auf dem Boden, Beine gestreckt. Ziehe beide Knie so hoch wie möglich aktiv zur Brust – ohne Arme. Miss die Distanz zwischen Knie und Brust.", benchmarks:{excellent:"0–5 cm",good:"5–15 cm",medium:"15–25 cm",foundation:">25 cm"}, interpretation:{excellent:"Crow und Firefly grundsätzlich bereit.",good:"Crow machbar, Firefly in Arbeit.",medium:"Compression-Training nötig.",foundation:"Hip Flexor Aktivierung priorisieren."} },
  { id:"hip_external_rotation",  name:"Hip External Rotation",   short:"Knie auf Hüfthöhe nach außen",   unit:"Grad",    emoji:"↩️", description:"Stehe auf einem Bein. Hebe das andere Knie auf Hüfthöhe und öffne es aktiv nach außen. Miss den Winkel der Außenrotation.", benchmarks:{excellent:">80°",good:"45–80°",medium:"20–45°",foundation:"<20°"}, interpretation:{excellent:"Pigeon und Lotus-Progression möglich.",good:"Hüftarbeit zeigt Wirkung.",medium:"External Rotation Strengthening nötig.",foundation:"Piriformis und Glute Med aktivieren."} },
  { id:"ankle_dorsiflexion",     name:"Ankle Dorsiflexion",       short:"Knie zur Wand ohne Ferse heben", unit:"cm Rest", emoji:"🦶", description:"Fuß 12 cm vor der Wand. Knie zur Wand bringen ohne Ferse abzuheben. Miss die verbleibende Distanz.", benchmarks:{excellent:"0 cm",good:"<2 cm",medium:"2–5 cm",foundation:">5 cm"}, interpretation:{excellent:"Tiefe Bodenposen uneingeschränkt.",good:"Kleines Defizit, nicht limitierend.",medium:"Ankle Mobility Training beginnen.",foundation:"Beeinflusst alle bodentiefen Posen."} },
  { id:"shoulder_flexion",       name:"Shoulder Flexion",         short:"Arme an Wand ohne Hohlkreuz",    unit:"cm",      emoji:"🙆", description:"Rücken an der Wand. Arme gestreckt nach oben – Wand berühren ohne Hohlkreuz. Miss den Abstand der Hände zur Wand.", benchmarks:{excellent:"0 cm",good:"5–10 cm",medium:"10–20 cm",foundation:">20 cm"}, interpretation:{excellent:"Handstand-Progression möglich.",good:"Schulter-Mobility-Work zahlt sich aus.",medium:"Latissimus und Trizeps mobilisieren.",foundation:"Shoulder Mobility als Priorität."} },
  { id:"hamstring_slr",          name:"Hamstring Length (SLR)",   short:"Gestrecktes Bein heben",         unit:"Grad",    emoji:"📐", description:"Rückenlage. Gestrecktes Bein ohne Schwung nach oben heben. Miss den Winkel zwischen Bein und Boden.", benchmarks:{excellent:"≥90°",good:"70–90°",medium:"50–70°",foundation:"<50°"}, interpretation:{excellent:"Splits und Firefly grundsätzlich möglich.",good:"Forward Folds gut, Splits in Arbeit.",medium:"Hamstring-Arbeit als Daily Routine.",foundation:"Mehrmals täglich kurze Einheiten."} },
];

function getPose(id)     { return POSES[id] || null; }
function getFullPose(id) { const p = getPose(id); if (!p) return null; return { ...p, ...(POSE_DETAILS[id]||{}) }; }
...
function getLatestDiagValue(vals) {
  if (vals?.week12 !== "" && vals?.week12 !== undefined) return vals.week12;
  if (vals?.week6  !== "" && vals?.week6  !== undefined) return vals.week6;
  return vals?.start || "";
}
...
const BM_COLORS = {
  excellent: { bg:"#EAF3DE", color:"#27500A", label:"Exzellent" },
  good:      { bg:"#EEF3FA", color:"#0C447C", label:"Gut" },
  medium:    { bg:"#FAEEDA", color:"#633806", label:"Mittel" },
  foundation:{ bg:"#FCEBEB", color:"#791F1F", label:"Foundation" },
};
...
const DEFAULT_PROGRESS = {
  ...
  poseProgress: {
    down_dog:      { bestHold:"", pain:false },
    dolphin:       { bestHold:"", pain:false },
    chaturanga:    { bestHold:"", pain:false },
    crow:          { bestHold:"", pain:false },
    l_sit:         { bestHold:"", pain:false },
    pigeon:        { bestHold:"", pain:false },
    half_lotus:    { bestHold:"", pain:false },
    flying_pigeon: { bestHold:"", pain:false },
  },
  diagnostics: {
...
const PHASES = [
  { num:1, title:"Foundation", weeks:"Woche 1-4", accent:"#1C3A5E", light:"#EEF3FA", days:[
    { tag:"Mo", session:"MCI Strength + Shoulder", focus:"Push - Schulter - Wrist Prep", note:"Wrist Prep IMMER vor Arm-Training.", exercises:[
      ...
      { name:"Scapula Push-ups", sets:"3x10", p:true, e:"💪", s:"Schulterblätter aktiv im Plank", d:"Plank, Arme gestreckt. Schulterblätter zusammenziehen dann weit auseinanderschieben.", st:["Plank, Arme gestreckt","Schulterblätter zusammenziehen","Dann weit auseinanderschieben","10 Wdh."], q:"scapula pushup tutorial", r:["plank","chaturanga"] },
      { name:"Slow Chaturanga Neg.", sets:"3x5", p:true, e:"⬇️", s:"4 Sek. langsam absenken", d:"Hohe Plank. Ellbogen eng, 4 Sek. absenken bis Oberarme parallel.", st:["Hohe Plank","Ellbogen eng an Körper","4 Sek. absenken","Oberarme parallel"], q:"chaturanga tutorial slow negative", r:["chaturanga","crow"] },
      { name:"Plank Hold", sets:"3x45 Sek.", p:false, e:"🏋️", s:"Schulter-Hüfte-Fersen Linie", d:"Handgelenke unter Schultern. Rippen schließen. Kein Hohlkreuz.", st:["Hände schulterbreit","Rippen schließen","Linie halten","45 Sek."], q:"perfect plank form", r:["plank"] },
      ...
      { name:"Shoulder Flexion Stretch", sets:"3x45 Sek.", p:false, e:"🙆", s:"Hände auf Block, Brust sinkt", d:"Hände auf Block. Schritt zurück. Brust passiv sinken.", st:["Hände auf Block","Schritt zurück","Brust sinken","45 Sek."], q:"shoulder flexion stretch block", r:["handstand","pincha"] },
    ]},
    { tag:"Di", session:"Yoga - Crow + Compression", focus:"Crow Approach - Core Compression", note:"KEY-Übungen nicht überspringen.", exercises:[
      ...
      { name:"Hollow Body Hold", sets:"3x20 Sek.", p:false, e:"🍌", s:"LWS flach, Beine 30 cm hoch", d:"LWS in Boden drücken. Beine 30 cm heben. Arme über Kopf.", st:["Rückenlage, LWS in Boden","Beine gestreckt 30 cm","Arme über Kopf","LWS-Kontakt halten"], q:"hollow body hold gymnastics", r:["l_sit","crow"] },
      { name:"Seated Compression Pulse", sets:"90 Sek.", p:false, e:"🧘", s:"Knie zur Brust, 2 Sek.", d:"Sitzen, Beine gestreckt. Knie aktiv zur Brust, 2 Sek. Rhythmisch.", st:["Sitzen, Beine gestreckt","Knie aktiv zur Brust","2 Sek. halten","90 Sek. rhythmisch"], q:"hip flexor compression drill", r:["tuck_hold","l_sit","crow"] },
      { name:"Tuck Hold", sets:"5x5 Sek.", p:true, e:"⭐", s:"Schultern drücken, Knie maximal hoch", d:"Hände neben Hüften. Schultern nach unten. Knie maximal hoch, 5 Sek.", st:["Hände neben Hüften","Schultern nach unten","Knie maximal hoch","5 Sek. kein Boden"], q:"tuck hold l-sit progression", r:["tuck_hold","crow","l_sit"] },
      { name:"Crow Lean Drill", sets:"5x10 Sek.", p:true, e:"🦅", s:"Schultern über Hände - Zehen am Boden", d:"Tiefe Hocke. Knie außen an Oberarme. Schultern über Handgelenke. Zehen am Boden.", st:["Tiefe Hocke","Knie außen an Oberarme","Schultern über Hände","10 Sek., Zehen am Boden"], q:"crow pose lean drill bakasana", r:["crow","flying_pigeon"] },
      { name:"Crow Hop", sets:"5x3 Sek.", p:true, e:"🐦", s:"Zehen heben sich - 1-2 Sek.", d:"Aus Crow Lean: Gewicht weiter bis Zehen sich heben. Nicht springen.", st:["Aus Crow Lean","Gewicht weiter vorne","Zehen heben sich","1-2 Sek., landen"], q:"crow pose first time tutorial", r:["crow"] },
      { name:"Passive Pigeon", sets:"2 Min./Seite", p:false, e:"🕊️", s:"Stirn auf Matte, entspannen", d:"Pigeon, Stirn auf Matte. Kein Kämpfen.", st:["Pigeon-Position","Oberkörper nach vorne","Stirn auf Matte","2 Min. entspannen"], q:"pigeon pose tutorial hips", r:["pigeon","double_pigeon"] },
    ]},
    { tag:"Mi", session:"Les Mills + Finisher", focus:"Kraft - L-Sit Finisher", note:"Finisher direkt nach Klasse.", exercises:[
      ...
      { name:"Tuck Hold auf Blöcken", sets:"4x5 Sek.", p:true, e:"📦", s:"Blöcke geben Höhe", d:"Zwei Blöcke. Schultern nach unten. Gesäß abheben.", st:["Blöcke mittlere Höhe","Hände auf Blöcke","Schultern nach unten","Gesäß abheben 5 Sek."], q:"tuck hold yoga blocks", r:["tuck_hold","l_sit","crow"] },
      { name:"Hip Flexor Isolation", sets:"3x12 Sek./Seite", p:false, e:"🦵", s:"Knie hoch, Hand dagegen", d:"Auf einem Bein. Knie hoch. Hand gegen Knie isometrisch.", st:["Auf einem Bein","Knie maximal hoch","Hand gegen Knie","12 Sek."], q:"hip flexor isometric standing", r:["tuck_hold","crow"] },
    ]},
    { tag:"Do", session:"Mobility - Hüfte", focus:"Hüftöffnung - Pigeon - Splits", note:"Rotation IMMER aus der Hüfte, nie aus dem Knie.", exercises:[
      { name:"90/90 Rotations", sets:"2 Min.", p:false, e:"↩️", s:"Hüfte aktiv rotieren", d:"90/90. Oberkörper über Vorderbein, dann Hinterbein.", st:["90/90-Position","Über Vorderbein","Dann Hinterbein","2-3 Sek."], q:"90 90 hip stretch tutorial", r:["pigeon","double_pigeon","half_lotus"] },
      { name:"Low Lunge", sets:"90 Sek./Seite", p:false, e:"🏹", s:"Hüfte nach vorne-unten", d:"Hinteres Knie am Boden. Hüfte nach vorne-unten.", st:["Hinteres Knie am Boden","Hüfte nach vorne-unten","Rücken lang","90 Sek."], q:"low lunge hip flexor yoga", r:["low_lunge","pigeon"] },
      { name:"Elevated Pigeon", sets:"2 Min./Seite", p:true, e:"🧱", s:"Block unter Gesäß", d:"Block unter Gesäß reduziert Knie-Stress.", st:["Pigeon-Position","Block unter Gesäß","Oberkörper nach vorne","2 Min."], q:"pigeon pose block knee safe", r:["pigeon","double_pigeon"] },
      ...
      { name:"Half Splits", sets:"90 Sek./Seite", p:false, e:"📐", s:"Fuß flexiert, Rücken gerade", d:"Vorderes Bein strecken. Fuß flexiert.", st:["Vorderes Bein strecken","Fuß flexieren","Rücken gerade","90 Sek."], q:"half splits yoga", r:["half_splits","hanumanasana","firefly"] },
      { name:"Double Pigeon", sets:"2 Min./Seite", p:true, e:"🔗", s:"Schienbein über Schienbein", d:"Schienbein auf Schienbein. Knie Richtung Boden.", st:["Unteres Bein parallel","Oberes Schienbein drauf","Knie Richtung Boden","2 Min."], q:"double pigeon fire log pose", r:["double_pigeon","half_lotus","flying_pigeon"] },
    ]},
    { tag:"Fr", session:"MCI + Inversion Prep", focus:"Pull - Inversion Vorbereitung", note:"Inversion Prep nach MCI.", exercises:[
      ...
      { name:"Dolphin Hold", sets:"3x30 Sek.", p:true, e:"🐬", s:"Unterarme parallel, Schultern aktiv", d:"Unterarme parallel. Hüfte hoch. Schulterblätter zusammen.", st:["Unterarme parallel","Hüfte hoch","Schulterblätter zusammen","30 Sek."], q:"dolphin pose headstand prep", r:["dolphin","headstand"] },
      { name:"Dolphin Rocks", sets:"3x8", p:false, e:"🌊", s:"Vor/zurück aus Dolphin", d:"Aus Dolphin vor und zurück.", st:["Dolphin","Nach vorne","Zurück","8 Wdh."], q:"dolphin rocks forearm balance", r:["dolphin","pincha"] },
    ...
    { tag:"Sa", session:"Yoga - Full Practice", focus:"Crow + Compression", note:"Samstag = Hauptsession.", exercises:[
      ...
      { name:"Compression Routine", sets:"8 Min.", p:true, e:"⭐", s:"Tuck 5x5 + Hollow + Pulses", d:"Pulses 90 Sek. → Tuck 5x5 → Hollow 3x20.", st:["Pulses 90 Sek.","Tuck 5x5 Sek.","Hollow 3x20 Sek."], q:"core compression crow routine", r:["tuck_hold","l_sit","crow"] },
      { name:"Crow Skill-Arbeit", sets:"15 Min.", p:true, e:"🦅", s:"Lean → Hop → Holds", d:"5 Min. Lean → 5 Min. Hops → 5 Min. Holds. 60 Sek. Pause.", st:["5 Min. Lean","5 Min. Hops","5 Min. Holds","60 Sek. Pause"], q:"crow pose progression tutorial", r:["crow"] },
      { name:"Hüftöffner-Serie", sets:"15 Min.", p:false, e:"🕊️", s:"Lizard → Pigeon → Double Pigeon", d:"Lizard 90 Sek. → Pigeon 2 Min. → Double Pigeon 2 Min.", st:["Lizard 90 Sek./Seite","Pigeon 2 Min./Seite","Double Pigeon 2 Min./Seite"], q:"hip opening yoga sequence", r:["pigeon","double_pigeon","flying_pigeon"] },
  ...
  { num:2, title:"Skill Building", weeks:"Woche 5-8", accent:"#2D5A3D", light:"#EEF6F1", days:[
    { tag:"Mo", session:"MCI + Handstand", focus:"Push - Handstand Conditioning", note:"Handstand nach MCI.", exercises:[
      ...
      { name:"Wall Handstand Hold", sets:"5x20 Sek.", p:true, e:"🤸", s:"Bauch-zur-Wand, dann rückwärts", d:"3x Bauch-zur-Wand. 2x Rückwärts.", st:["3x Bauch-zur-Wand","2x Rückwärts","Schultern drücken","20 Sek."], q:"wall handstand tutorial", r:["handstand"] },
      { name:"Shoulder Tap Handstand", sets:"3x5 Taps", p:true, e:"👋", s:"Hand abheben", d:"Wall Handstand. Hand 2 cm abheben, 2-3 Sek.", st:["Wall Handstand","Hand 2 cm heben","2-3 Sek.","Wechseln"], q:"handstand shoulder tap", r:["handstand"] },
    ]},
    { tag:"Di", session:"Yoga - Crow + L-Sit", focus:"Crow 10 Sek. - L-Sit Progression", note:"Crow-Ziel: 10 Sek.", exercises:[
      ...
      { name:"Compression Routine", sets:"8 Min.", p:true, e:"⭐", s:"Tuck 5x8 + One Leg Extended", d:"Pulses + Tuck 5x8 + One Leg Extended 4x5.", st:["Pulses 90 Sek.","Tuck 5x8 Sek.","One Leg Extended"], q:"l-sit one leg extended", r:["tuck_hold","l_sit"] },
      { name:"Crow Hold", sets:"6x max.", p:true, e:"🦅", s:"Ziel: 10 Sek.", d:"Crow Hold. Ziel 10 Sek. 60 Sek. Pause.", st:["Crow","Max. Hold","60 Sek. Pause"], q:"crow pose 10 seconds", r:["crow"] },
      { name:"Passive Pigeon", sets:"2 Min./Seite", p:false, e:"🕊️", s:"Entspannen", d:"2 Min./Seite.", st:["Pigeon","2 Min."], q:"pigeon pose", r:["pigeon"] },
    ]},
    { tag:"Mi", session:"Les Mills + L-Sit", focus:"Kraft - L-Sit Steigerung", note:"Ein Bein extended wenn Tuck 8 Sek. sitzt.", exercises:[
      ...
      { name:"One Leg Extended", sets:"4x5 Sek.", p:true, e:"🦵", s:"Ein Bein strecken", d:"Aus Tuck: ein Bein strecken, anderes Knie hoch.", st:["Tuck Hold","Ein Bein strecken","Anderes Knie hoch","5 Sek."], q:"one leg extended l-sit", r:["l_sit"] },
      { name:"Crow Pulse", sets:"3x10", p:false, e:"🔄", s:"Hüfte 2-3 cm heben/senken", d:"Crow. Hüfte rhythmisch. Zehen am Boden.", st:["Crow","Zehen am Boden","Hüfte 2-3 cm","10 Wdh."], q:"crow pulse drill", r:["crow"] },
    ]},
    { tag:"Do", session:"Mobility + Headstand", focus:"Hüfte tiefer - Headstand", note:"Headstand nur wenn Dolphin 45 Sek. stabil!", exercises:[
      { name:"Double Pigeon", sets:"3 Min./Seite", p:true, e:"🔗", s:"3 Min. tiefer", d:"3 Min./Seite.", st:["Schienbein über Schienbein","3 Min."], q:"double pigeon deeper", r:["double_pigeon","half_lotus"] },
      { name:"Dolphin Hold", sets:"3x45 Sek.", p:false, e:"🐬", s:"45 Sek. - Headstand Basis", d:"45 Sek.", st:["Unterarme","Hüfte hoch","45 Sek."], q:"dolphin hold", r:["dolphin","headstand"] },
      { name:"Headstand Approach", sets:"5x5 Sek.", p:true, e:"🙃", s:"Kopf auf Matte, Knie zur Brust", d:"Dolphin → Kopf auf Matte → Knie zur Brust. Gewicht auf UNTERARMEN.", st:["Dolphin","Kopf auf Matte","Hüfte hoch","Knie zur Brust 5 Sek."], q:"headstand tutorial beginners", r:["headstand"] },
    ]},
    { tag:"Fr", session:"MCI + Pincha Approach", focus:"Pull - Forearm Balance", note:"Pincha erst wenn Headstand stabil.", exercises:[
      ...
      { name:"Forearm Balance Approach", sets:"4x10 Sek.", p:true, e:"🤸", s:"Unterarme parallel, Hüfte hoch", d:"Pincha Approach. 10 Sek.", st:["Unterarme parallel","Hüfte hoch","Schulterblätter zusammen","10 Sek."], q:"pincha mayurasana tutorial", r:["pincha"] },
    ...
    { tag:"Sa", session:"Yoga - Full Practice P2", focus:"Crow 15 Sek. - Headstand - Side Crow", note:"Crow-Ziel: 15 Sek.", exercises:[
      { name:"Compression Routine", sets:"8 Min.", p:true, e:"⭐", s:"Phase 2", d:"Tuck 5x8 + One Leg Extended + Hollow 3x25.", st:["Tuck 5x8","One Leg Extended","Hollow 3x25"], q:"compression yoga", r:["tuck_hold","l_sit"] },
      { name:"Crow Skill-Arbeit", sets:"15 Min.", p:true, e:"🦅", s:"Ziel: 15 Sek.", d:"15 Sek. Ziel.", st:["Hold-Versuche","15 Sek. Ziel"], q:"crow 15 seconds", r:["crow"] },
      { name:"Side Crow Approach", sets:"4x5 Sek.", p:false, e:"🌀", s:"Beide Knie auf einen Arm", d:"Rotation aus der Hüfte.", st:["Tiefe Hocke","Beide Knie auf einen Arm","Rotation aus Hüfte"], q:"side crow tutorial", r:["side_crow"] },
      { name:"Headstand", sets:"4x10 Sek.", p:false, e:"🙃", s:"Freistellend oder Wand", d:"10 Sek.", st:["Headstand","10 Sek."], q:"headstand hold", r:["headstand"] },
  ...
  { num:3, title:"Integration", weeks:"Woche 9-12", accent:"#5C3A1E", light:"#F6F0EA", days:[
    { tag:"Mo", session:"MCI + Handstand Daily", focus:"Push - Handstand täglich", note:"Handstand täglich.", exercises:[
      ...
      { name:"MCI Haupttraining", sets:"~40 Min.", p:false, e:"🏋️", s:"Push Pattern", d:"Push-Tag.", st:["Push Pattern"], q:"push workout" },
      { name:"Wall Handstand Hold", sets:"5x25 Sek.", p:true, e:"🤸", s:"Rückwärts - 25 Sek.", d:"Rückwärts. Rippen schließen.", st:["Rückwärts zur Wand","Rippen schließen","25 Sek."], q:"wall handstand back to wall", r:["handstand"] },
      { name:"Kick-Up Technik", sets:"10 Versuche", p:true, e:"⬆️", s:"Kontrolliert - kein Schwung", d:"Ein Bein führt, kein Schwung.", st:["Ein Bein führt","Anderes folgt","Kein Schwung"], q:"handstand kick up controlled", r:["handstand"] },
    ]},
    { tag:"Di", session:"Yoga - Crow + Firefly", focus:"Crow 20 Sek. - Firefly - L-Sit", note:"Firefly erst wenn Crow stabil + L-Sit 5 Sek.", exercises:[
      { name:"Compression Routine", sets:"8 Min.", p:true, e:"⭐", s:"L-Sit + Hollow 30 Sek.", d:"L-Sit Attempt 5x5 + Hollow 3x30.", st:["L-Sit 5x5","Hollow 3x30"], q:"l-sit tutorial", r:["l_sit","crow"] },
      { name:"Crow Hold", sets:"5x max.", p:true, e:"🦅", s:"Ziel: 20 Sek.", d:"20 Sek. Ziel. 60 Sek. Pause.", st:["Crow","20 Sek. Ziel","60 Sek. Pause"], q:"crow 20 seconds", r:["crow"] },
      { name:"Firefly Approach", sets:"4x8 Sek.", p:true, e:"🔥", s:"Arme unter Beine", d:"Vorwärtsbeuge. Arme unter Beine. Gewicht nach vorne.", st:["Tiefe Vorwärtsbeuge","Arme unter Beine","Hände auf Boden","Gewicht nach vorne"], q:"firefly pose tittibhasana", r:["firefly","l_sit"] },
      { name:"Passive Pigeon", sets:"2 Min./Seite", p:false, e:"🕊️", s:"Entspannen", d:"2 Min./Seite.", st:["Pigeon","2 Min."], q:"pigeon pose", r:["pigeon"] },
    ]},
    { tag:"Mi", session:"Les Mills + L-Sit", focus:"Kraft - L-Sit Hold", note:"Ziel: beidseitiger L-Sit.", exercises:[
      { name:"Les Mills / Barre", sets:"45-60 Min.", p:false, e:"🎵", s:"Volle Intensität", d:"Reguläre Klasse.", st:["Kursplan"], q:"les mills" },
      { name:"L-Sit Attempt", sets:"5x max.", p:true, e:"⭐", s:"Beide Beine parallel", d:"Beide Beine parallel. Auch 1 Sek. zählt.", st:["Hände auf Blöcken","Schultern drücken","Beide Beine parallel","Max. Hold"], q:"l-sit tutorial full", r:["l_sit"] },
      { name:"Tuck Jump to Hold", sets:"4x6", p:false, e:"🦘", s:"Knie zur Brust aus Hocke", d:"Füße abheben. Knie zur Brust. 1 Sek.", st:["Tiefe Hocke","Füße abheben","Knie zur Brust","1 Sek."], q:"tuck jump hip flexion", r:["tuck_hold","l_sit"] },
    ]},
    { tag:"Do", session:"Mobility - Splits + Flying Pigeon", focus:"Full Splits - Flying Pigeon", note:"Flying Pigeon erst wenn Double Pigeon entspannt + Crow stabil.", exercises:[
      { name:"Double Pigeon", sets:"3 Min./Seite", p:true, e:"🔗", s:"Tiefer, Block weglassen", d:"3 Min./Seite.", st:["Schienbein über Schienbein","3 Min."], q:"double pigeon deep", r:["double_pigeon","half_lotus"] },
      { name:"Full Splits Approach", sets:"3-5 Min.", p:true, e:"🤸", s:"Blöcke, täglich tiefer", d:"Blöcke. Hüfte quadratisch. Täglich tiefer.", st:["Blöcke unter Händen","Hüfte quadratisch","Täglich tiefer"], q:"full splits progression", r:["hanumanasana"] },
      { name:"Standing Figure-4 Lean", sets:"3x8 Sek.", p:true, e:"4️⃣", s:"Gewicht nach vorne", d:"Auf einem Bein. Knöchel auf Oberschenkel. Oberkörper nach vorne.", st:["Auf einem Bein","Knöchel auf Oberschenkel","Standbein beugen","Oberkörper nach vorne"], q:"standing figure 4 flying pigeon", r:["standing_figure4","flying_pigeon"] },
      { name:"Figure-4 auf Blöcken", sets:"4x8 Sek.", p:false, e:"🧱", s:"Hände auf Blöcken", d:"Wie oben, mit Blöcken.", st:["Blöcke","Figure-4 tiefer","8 Sek."], q:"flying pigeon blocks", r:["standing_figure4","flying_pigeon"] },
    ]},
    { tag:"Fr", session:"MCI + Pincha / Handstand", focus:"Pull - Forearm Balance 15 Sek.", note:"Pincha-Ziel: 15-20 Sek.", exercises:[
      { name:"Wrist Prep", sets:"5 Min.", p:false, e:"🤲", s:"Vollständig", d:"Vollständig.", st:["Vollständig"], q:"wrist prep" },
      { name:"MCI Haupttraining", sets:"~40 Min.", p:false, e:"🏋️", s:"Pull Pattern", d:"Pull-Tag.", st:["Pull Pattern"], q:"pull workout" },
      { name:"Forearm Balance Hold", sets:"4x15 Sek.", p:true, e:"🤸", s:"Pincha 15 Sek.", d:"Pincha gegen Wand. 15 Sek.", st:["Unterarme parallel","Hüfte über Schultern","15 Sek."], q:"pincha hold tutorial", r:["pincha"] },
      { name:"Kick-Up", sets:"8 Versuche", p:false, e:"⬆️", s:"Kontrolliert", d:"Kontrolliert.", st:["Ein Bein führt","Kontrolliert"], q:"handstand kick up", r:["handstand"] },
    ]},
    { tag:"Sa", session:"Yoga - Full Integration", focus:"Flying Pigeon - Crow 20 Sek.", note:"Alle Skills zusammenbringen.", exercises:[
      { name:"Compression Routine", sets:"8 Min.", p:true, e:"⭐", s:"L-Sit + Hollow 30 Sek.", d:"L-Sit 5x max. + Hollow 3x30.", st:["L-Sit 5x max.","Hollow 3x30"], q:"l-sit compression", r:["l_sit","crow"] },
      { name:"Crow + Firefly", sets:"15 Min.", p:true, e:"🦅", s:"Crow 20 Sek. → Firefly", d:"Crow 20 Sek. → Firefly.", st:["Crow 20 Sek.","Firefly danach"], q:"crow firefly transition", r:["crow","firefly"] },
      { name:"Flying Pigeon Approach", sets:"10 Min.", p:true, e:"🕊️", s:"Figure-4 → Blöcke → Gewicht", d:"Standing Figure-4 → Blöcke → Gewicht auf Hände.", st:["Standing Figure-4 3x8","Figure-4 Blöcke 4x8","Gewicht auf Hände"], q:"flying pigeon tutorial", r:["flying_pigeon","standing_figure4"] },
  ...
  return (
    <div style={{padding:"12px 16px 100px"}}>
      <div style={{padding:"12px 14px",background:"#fff",borderRadius:"14px",marginBottom:"12px",fontSize:"13px",color:"#3A3A3C",lineHeight:1.55,boxShadow:"0 1px 3px rgba(0,0,0,0.05)"}}>
        5 Tests – Woche 1 (Start), Woche 6 (Mitte), Woche 12 (Ende). Die App bewertet immer den neuesten eingetragenen Wert.
      </div>
      {DIAGNOSTIC_TESTS.map(test => {
        const vals = diag[test.id] || { start:"", week6:"", week12:"" };
        const latest = getLatestDiagValue(vals);
        const bm = getBenchmark(test.id, latest);
          ...
          <div key={test.id} style={{background:"#fff",borderRadius:"16px",padding:"16px",marginBottom:"12px",boxShadow:"0 1px 3px rgba(0,0,0,0.05)"}}>
            ...
            {bmc && (
              <div style={{padding:"10px 12px",background:bmc.bg,borderRadius:"10px",marginBottom:"10px"}}>
                <div style={{fontSize:"11px",fontWeight:700,color:bmc.color,marginBottom:"3px"}}>{bmc.label} · {latest} {test.unit}</div>
...
function MasterPosesTab({ progress, setProgress }) {
  ...
  const ps = progress.poseStatus || {};
  const pp = progress.poseProgress || {};
  ...
  const updatePain   = (id, pain)   => setProgress(prev => ({ ...prev, poseProgress: { ...prev.poseProgress, [id]: { ...(prev.poseProgress?.[id]||{}), pain } } }));
  return (
    <div style={{padding:"12px 16px 100px"}}>
      <div style={{padding:"12px 14px",background:"#fff",borderRadius:"14px",marginBottom:"12px",fontSize:"13px",color:"#3A3A3C",lineHeight:1.55,boxShadow:"0 1px 3px rgba(0,0,0,0.05)"}}>
        Deine 8 Master-Posen. Status editierbar, Bestleistung trackbar.
      </div>
      {MASTER_POSE_IDS.map(id => {
        const pose = getPose(id);
        const det = MASTER_DETAILS[id] || {};
        if (!pose) return null;
        const st = ps[id] || pose.defaultStatus;
        const sc = STATUS[st] || STATUS.open;
        const p = pp[id] || {};
        const isOpen = open === id;
        const pct = p.bestHold && det.targetHold ? Math.min(100,(parseFloat(p.bestHold)/det.targetHold)*100) : 0;
        return (
          <div key={id} style={{background:"#fff",borderRadius:"16px",overflow:"hidden",marginBottom:"10px",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",border:p.pain?"1.5px solid #E24B4A":"none"}}>
            <button onClick={()=>setOpen(isOpen?null:id)} style={{width:"100%",padding:"14px 16px",background:"transparent",border:"none",textAlign:"left",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",gap:"12px"}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{display:"flex",alignItems:"center",gap:"8px",marginBottom:"3px"}}>
                  ...
                  {p.pain && <span style={{fontSize:"10px",fontWeight:700,color:"#A32D2D",background:"#FCEBEB",padding:"2px 8px",borderRadius:"10px"}}>⚠ Schmerz</span>}
                </div>
                ...
                <div style={{display:"flex",alignItems:"center",gap:"6px"}}>
                  ...
                  {p.bestHold && <span style={{fontSize:"11px",color:"#1C3A5E",marginLeft:"8px",fontWeight:600}}>{p.bestHold} {det.unit}</span>}
                </div>
              </div>
            ...
            {isOpen && (
              <div style={{borderTop:"1px solid #F2F2F7",padding:"14px 16px"}}>
                {p.pain && (
                  <div style={{padding:"10px 12px",background:"#FCEBEB",borderRadius:"10px",borderLeft:"3px solid #E24B4A",marginBottom:"14px"}}>
                    <div style={{fontSize:"12px",fontWeight:700,color:"#A32D2D",marginBottom:"3px"}}>⚠ Schmerz / Reiz aktiv</div>
                    <div style={{fontSize:"12px",color:"#791F1F"}}>Nicht forcieren. Technik prüfen. Wenn nötig regressieren.</div>
                  </div>
                )}
                {det.focus && <div style={{fontSize:"13px",color:"#3A3A3C",lineHeight:1.6,marginBottom:"10px"}}><strong>Fokus:</strong> {det.focus}</div>}
                {det.biggestLimit && (
                  <div style={{padding:"10px 12px",background:"#FFF9F0",borderRadius:"10px",borderLeft:"3px solid #BA7517",marginBottom:"14px"}}>
                    ...
                    <div style={{fontSize:"13px",color:"#3A3A3C"}}>{det.biggestLimit}</div>
                  </div>
                )}
                {det.readiness && (
                ...
                {det.bestDrills && (
                  <div style={{marginBottom:"14px"}}>
                    ...
                    <div style={{display:"flex",flexWrap:"wrap",gap:"6px"}}>
                      {det.bestDrills.map(d=><span key={d} style={{fontSize:"12px",background:"#EEF3FA",color:"#1C3A5E",padding:"4px 10px",borderRadius:"20px",fontWeight:500}}>{d}</span>)}
                    </div>
                  </div>
                )}
                {det.targetHold && (
                  <div style={{marginBottom:"14px"}}>
                    <div style={{fontSize:"10px",fontWeight:700,color:"#8E8E93",textTransform:"uppercase",letterSpacing:"0.8px",marginBottom:"8px"}}>Bestleistung</div>
                    <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
                      <input type="number" placeholder={`Aktuell (${det.unit})`} value={p.bestHold||""} onChange={e=>updateHold(id,e.target.value)} style={{flex:1,padding:"10px",borderRadius:"10px",border:"1px solid #E5E5EA",fontSize:"14px",fontFamily:"inherit",background:"#F9F9F9"}}/>
                      <span style={{fontSize:"12px",color:"#8E8E93",whiteSpace:"nowrap"}}>Ziel: {det.targetHold} {det.unit}</span>
                    </div>
                    {pct > 0 && (
                ...
                <label style={{display:"flex",alignItems:"center",gap:"10px",cursor:"pointer",padding:"10px 12px",background:"#F9F9F9",borderRadius:"10px"}}>
                  <input type="checkbox" checked={!!p.pain} onChange={e=>updatePain(id,e.target.checked)} style={{width:"18px",height:"18px",cursor:"pointer"}}/>
                  <span style={{fontSize:"13px",color:"#3A3A3C"}}>Schmerz / Reiz aktuell</span>
                </label>
              </div>
            )}
          </div>
...
// ─── SKILL MAP ────────────────────────────────────────────────────────────────
function SkillMap({ progress, initialOpenPoseId, onPoseJumpHandled }) {
  const [openPose, setOpenPose] = useState(null);
  const [openTree, setOpenTree] = useState(null);

  useEffect(() => {
    if (!initialOpenPoseId) return;
    const tree = findTreeForPose(initialOpenPoseId);
    if (!tree) return;
    setOpenTree(tree.id);
    setOpenPose(initialOpenPoseId);
    setTimeout(() => {
      const el = document.getElementById(`pose-${initialOpenPoseId}`);
      if (el) el.scrollIntoView({ behavior:"smooth", block:"start" });
    }, 120);
    if (onPoseJumpHandled) onPoseJumpHandled();
  }, [initialOpenPoseId]);
            ...
            {poses.map(pose => {
              ...
              return (
                <div key={pose.id} id={`pose-${pose.id}`} style={{marginTop:"6px",background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",border:pose.priority?`1.5px solid ${tree.color}55`:"1px solid #E5E5EA"}}>
                  ...
                  {isOpen && (
                    <div style={{borderTop:"1px solid #F2F2F7",padding:"14px 16px"}}>
                      {pose.why && <div style={{marginBottom:"14px"}}><div style={{fontSize:"10px",fontWeight:700,color:"#8E8E93",textTransform:"uppercase",letterSpacing:"0.8px",marginBottom:"6px"}}>Warum diese Pose</div><p style={{fontSize:"13px",color:"#3A3A3C",lineHeight:1.6,margin:0}}>{pose.why}</p></div>}
                      {pose.nextStep && (
                      ...
                      {pose.connects?.length > 0 && (
                        <div style={{marginBottom:"14px"}}>
                          ...
                          <div style={{display:"flex",flexWrap:"wrap",gap:"6px"}}>
                            {pose.connects.map(cid => {
                              const cp = getPose(cid); if (!cp) return null;
                              return <button key={cid} onClick={()=>jumpToPose(cid)} style={{fontSize:"12px",background:tree.light,color:tree.color,padding:"4px 10px",borderRadius:"20px",fontWeight:500,border:"none",cursor:"pointer",fontFamily:"inherit"}}>{cp.emoji} {cp.name}</button>;
                            })}
                          </div>
                        </div>
                      )}
...
// ─── TRAINING ─────────────────────────────────────────────────────────────────
function Training({ progress, setProgress, onOpenSkillPose }) {
  ...
  const renderRelatedPoses = (relIds=[]) => {
    if (!relIds?.length) return null;
    return (
      <div style={{marginTop:"12px"}}>
        <div style={{fontSize:"10px",fontWeight:700,color:"#8E8E93",textTransform:"uppercase",letterSpacing:"0.8px",marginBottom:"8px"}}>Hilft diesen Posen</div>
        <div style={{display:"flex",flexWrap:"wrap",gap:"6px"}}>
          {relIds.map(pid => {
            const pose = getPose(pid); if (!pose) return null;
            return (
              <button key={pid} onClick={ev=>{ev.stopPropagation();onOpenSkillPose&&onOpenSkillPose(pid);}} style={{fontSize:"12px",background:"#EEF3FA",color:"#1C3A5E",padding:"4px 10px",borderRadius:"20px",fontWeight:500,border:"none",cursor:"pointer",fontFamily:"inherit"}}>
            ...
            <div key={i} style={{marginBottom:"8px",background:"#fff",borderRadius:"16px",overflow:"hidden",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",opacity:isCk?0.6:1}}>
              <div style={{display:"flex",alignItems:"center",padding:"12px 14px",gap:"10px",cursor:"pointer"}} onClick={()=>setOpenEx(isOp?null:k)}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  {ex.r?.length>0 && !isOp && (
                    <div style={{fontSize:"10px",color:"#1C3A5E",marginTop:"3px",fontWeight:600}}>
                      Unterstützt {ex.r.length} Pose{ex.r.length>1?"n":""}
                    </div>
                  )}
                </div>
...
export default function App() {
  ...
  const [progress, setProgress] = useLocalStorage("yoga-v5-progress", DEFAULT_PROGRESS);
  const [pendingPose, setPendingPose] = useState(null);

  const openSkillPose = (poseId) => {
    setPendingPose(poseId);
    setTab("skillmap");
  };
  ...
  return (
    <div style={{fontFamily:"-apple-system,'SF Pro Display',BlinkMacSystemFont,sans-serif",background:"#F2F2F7",minHeight:"100vh",maxWidth:"430px",margin:"0 auto"}}>
      ...
      {tab==="training" && <Training progress={progress} setProgress={setProgress} onOpenSkillPose={openSkillPose}/>}
      {tab==="master"   && <MasterPosesTab progress={progress} setProgress={setProgress}/>}
      {tab==="skillmap" && <SkillMap progress={progress} initialOpenPoseId={pendingPose} onPoseJumpHandled={()=>setPendingPose(null)}/>}
